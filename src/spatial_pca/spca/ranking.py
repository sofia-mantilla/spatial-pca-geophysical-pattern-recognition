...
def rank_multi_two_stage_pca_fusion(
    *,
    ...
    fusion_details = {
        ...
        "stage1_pca_svd_solver": stage1_pca_svd_solver,
        "fused_pca_svd_solver": fused_pca_svd_solver,
        "fused_eigenvalues": np.asarray(eig_fused, dtype=float),
        "stage1_eigenvalues_var1": np.asarray(pca1.explained_variance_, dtype=float),
        "stage1_eigenvalues_var2": np.asarray(pca2.explained_variance_, dtype=float),
